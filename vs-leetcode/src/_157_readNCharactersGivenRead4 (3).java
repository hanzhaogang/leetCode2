 ...
 * using a given method read4, implement a method to read  n  characters.
...
Note: buf[] is destination not source, 
the results from read4 will be copied to buf[]
Below is a high level example of how read4 works:

// File is "abcdefghijk", initially file pointer (fp) points to 'a'
File file("abcdefghijk"); 
// Create buffer with enough space to store characters
char[] buf = new char[4];
// read4 returns 4. Now buf = "abcd", fp points to 'e'
read4(buf);
// read4 returns 4. Now buf = "efgh", fp points to 'i'
read4(buf); 
// read4 returns 3. Now buf = "ijk", fp points to end of file
read4(buf);  
...
Note: 
buf[] is destination not source, 
you will need to write the results to buf[]
