...
0 <= nums.length <= 3 * 104
    ...
    use two pointers, p1 is pointing to (the end of the new array + 1). p2 is used to iterate the input array.
    finally the length of the new array should be p1.
    
 */
public class _80_RemoveDuplicatesfromSortedArrayII {//[0,0,0,1,2,2,4,4]
