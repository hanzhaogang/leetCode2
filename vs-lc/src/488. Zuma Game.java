...
Given a string board, representing the row of balls on the board, 
...
The initial row of balls on the board 
will not have any groups of three or more consecutive balls of the same color.
