public class 1366. Rank Teams by Votes {
...
思路：
根据第一个voter给出的vote，得到所有的team。
建立一个Map<String,int[]> team2voteMap,表示每个team得了几个第一、几个第二，。。。
遍历所有的vote，计算出team2voteMap的值。
然后，建立一个TreeMap<String,Queue<String>> 根据team2voteMap，
*/
