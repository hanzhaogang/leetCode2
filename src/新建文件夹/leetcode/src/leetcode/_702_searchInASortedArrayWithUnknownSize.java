 ...
 * where ArrayReader.get(k) returns the element of the array at index k 
 * (0-indexed).
 ...
 */
public class _702_searchInASortedArrayWithUnknownSize {
	public int search(ArrayReader reader, int target) {
		int hi=Integer.MAX_VALUE;
		
		while(reader.get(hi)==Integer.MAX_VALUE) {
			hi/=2;
		}
	...
	private int bs(int lo,int hi,int target) {
